...
namespace AspMvcSqliteWebApplication.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Gender,Salary,DepartmentId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Gender,Salary,DepartmentId")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
